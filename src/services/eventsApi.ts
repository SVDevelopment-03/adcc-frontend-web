...
export const createEvent = async (
  ...
  try {
    ...
    formData.append("registrationFeeType", eventData.registrationFeeType || "free");
    formData.append("registrationFeeAmount", String(eventData.registrationFeeAmount ?? 0));
...
export const updateEvent = async (
  ...
  try {
    ...
    append('registrationFeeType', d.registrationFeeType);
    append('registrationFeeAmount', d.registrationFeeAmount);
