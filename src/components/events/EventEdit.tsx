      ...
      const payload = {
        ...
        registrationFeeAmount:
          formData.registrationFeeType === 'paid'
            ? Number(formData.registrationFeeAmount) || 0
            : 0,
            ...
            <div className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        registrationFeeType: e.target.value as 'free' | 'paid',
                        registrationFeeAmount:
                          e.target.value === 'paid' ? formData.registrationFeeAmount : 0,
                      })
                    }
                    className="w-full px-4 py-2 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-red-600"
                  >
                    <option value="free">{t('events.create.registrationFeeOptions.free')}</option>
                    <option value="paid">{t('events.create.registrationFeeOptions.paid')}</option>
                  </select>
                </div>
              </div>
              ...
              {formData.registrationFeeType === 'paid' && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm mb-2" style={{ color: '#666' }}>
                      {t('events.create.registrationFeeAmount')}
                    </label>
                    <input
                      type="number"
                      min="0"
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          registrationFeeAmount: Math.max(0, Number(e.target.value) || 0),
                        })
                      }
                      placeholder={t('events.create.placeholders.registrationFeeAmount')}
                      className="w-full px-4 py-2 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-red-600"
                    />
                  </div>
                </div>
